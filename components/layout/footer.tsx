...
import IsTurboNativeUserAgentFromServerComponent from "../hotwire/IsTurboNativeUserAgentFromServerComponent";
...
export default async function Footer() {
  ...
  return (
    <>
      ...
      <footer className={`border-t border-neutral-200 text-sm text-neutral-500 dark:border-neutral-700 dark:text-neutral-400 ${isTurboNativeUserAgentDetected ? 'mb-[68px]' : ''}`}>
